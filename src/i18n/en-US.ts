...
export default {
  common: {
    ...
    saveConfirmMessage: 'Double-check the entered data before saving.',
  },
  ...
  layout: {
    ...
    navWorkplaceAddressReport: 'Sites report',
    navWorkplaceAddressReportDaily: 'Detailed (by day)',
    navWorkplaceAddressReportMonthly: 'Summary (by month)',
    navEmployeeRates: 'Employee rates',
    navWorkplaceAddress: 'Sites',
    navUsers: 'Users',
  },
  ...
  meta: {
    title: {
      ...
      workplaceAddressReport: 'Sites report',
      workplaceAddressSummaryReport: 'Sites summary',
      employeeRates: 'Employee rates',
      workplaceAddress: 'Sites',
      users: 'Users',
      fallback: 'BRW Bau',
    },
  },
  ...
  home: {
    ...
    pickWorkplaceAddressFirst: 'Pick a site first',
  ...
  settings: {
    ...
    defaultWorkplaceAddressLabel: 'Default site',
    defaultWorkplaceAddressHint: 'Pre-filled into the hours form',
  ...
  reports: {
    ...
    monthly: {
      ...
      workplaceAddressLabel: 'Site',
      workplaceAddressPlaceholder: 'Select a site',
      allWorkplaceAddresses: 'All sites',
      dateLabel: 'Date',
      startTimeLabel: 'Start',
      endTimeLabel: 'End',
      columnDate: 'Date',
      columnWeekday: 'Weekday',
      columnWorkplaceAddress: 'Site',
      columnTime: 'Time',
      columnHours: 'Hours',
      columnBreak: 'Break',
      columnEarned: 'Earned',
