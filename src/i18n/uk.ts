const uk = {
  common: {
    ...
    hoursOnly: '{h} год',
    saveConfirmTitle: 'Зберегти зміни?',
    saveConfirmMessage: 'Перевірте введені дані перед збереженням.',
  },
  ...
  layout: {
    ...
    navWorkplaceAddressReportMonthly: 'Підсумковий (за місяць)',
    navEmployeeRates: 'Ставки співробітників',
    navWorkplaceAddress: "Об'єкти",
  ...
  meta: {
    title: {
      ...
      workplaceAddressSummaryReport: "Підсумок по об'єктах",
      employeeRates: 'Ставки співробітників',
      workplaceAddress: "Об'єкти",
      users: 'Користувачі',
      fallback: 'BRW Bau',
    },
  },
  ...
  home: {
    ...
    pickWorkplaceAddressFirst: "Спершу оберіть об'єкт",
  ...
  settings: {
    ...
    defaultWorkplaceAddressLabel: "Об'єкт за замовчуванням",
    defaultWorkplaceAddressHint: 'Підставляється у форму годин',
  ...
  reports: {
    ...
    monthly: {
      ...
      workplaceAddressLabel: "Об'єкт",
      workplaceAddressPlaceholder: "Виберіть об'єкт",
      allWorkplaceAddresses: "Всі об'єкти",
      dateLabel: 'Дата',
      startTimeLabel: 'Початок',
      endTimeLabel: 'Кінець',
      columnDate: 'Дата',
      columnWeekday: 'День тижня',
      columnWorkplaceAddress: "Об'єкт",
      columnTime: 'Час',
      columnHours: 'Години',
      columnBreak: 'Перерва',
      columnEarned: 'Сума',
  ...
  admin: {
    rates: {
      ...
      lunchBreakLabel: 'Обідня перерва',
      lunchBreakOption30: '30 хв',
      lunchBreakOption60: '60 хв',
      minutesSuffix: 'хв',
