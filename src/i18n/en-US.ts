...
export default {
  ...
  validation: {
    ...
    requiredWorkplaceAddressName: 'Enter a workplace address name',
    requiredCity: 'Enter a city',
    requiredStreet: 'Enter a street',
    requiredHouseNumber: 'Enter a house number',
    requiredWorkplaceAddress: 'Select a workplace address',
  ...
  layout: {
    ...
    navWorkplaceAddress: 'Workplace addresses',
    navUsers: 'Users',
  },
  ...
  meta: {
    title: {
      ...
      workplaceAddressSummaryReport: 'Workplace address summary',
      employeeRates: 'Employee rates',
      workplaceAddress: 'Workplace addresses',
      users: 'Users',
      fallback: 'BRW Bau',
    },
  },
  ...
  home: {
    ...
    pickWorkplaceAddressFirst: 'Pick a workplace address first',
  ...
  settings: {
    ...
    defaultWorkplaceAddressLabel: 'Default workplace address',
  ...
  reports: {
    ...
    monthly: {
      ...
      workplaceAddressLabel: 'Workplace address',
      workplaceAddressPlaceholder: 'Select a workplace address',
      allWorkplaceAddresses: 'All workplace addresses',
      dateLabel: 'Date',
      startTimeLabel: 'Start',
      endTimeLabel: 'End',
      columnDate: 'Date',
      columnWeekday: 'Weekday',
      columnWorkplaceAddress: 'Workplace address',
      columnTime: 'Time',
      columnHours: 'Hours',
      columnBreak: 'Break',
      columnEarned: 'Earned',
  ...
  admin: {
    ...
    workplaceAddress: {
      title: 'Workplace addresses',
      nameLabel: 'Workplace address name',
      cityLabel: 'City',
      streetLabel: 'Street',
